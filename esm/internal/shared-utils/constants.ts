...
export const binUtilsAssetsFolderName = 'assets';

export const githubWorkflowsPublishPath = `${githubFolderName}/${workflowsFolderName}/${githubWorkflowsPublishFilename}`;
export const githubWorkflowsPagesPath = `${githubFolderName}/${workflowsFolderName}/${githubWorkflowsPagesFilename}`;
export const tsconfigBasePath = `${slashedScope}${configsPackageName}/TsconfigBase`;
...
export const configsPeerDependencies = {
  ...
  eslint: '9.39.1',
  /* Used by the prettierConfig.ts file. Must be imported as a peerDependency because the client of the configs package will need it: the plugin is not loaded by the configs package as is the case for eslint, but by prettier directly */
