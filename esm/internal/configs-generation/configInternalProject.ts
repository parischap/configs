      ...
      [packageJsonFilename]: {
        ...
        scripts: {
          ...
          ...(prefixForAutogeneratedIndex === '' ?
            {}
          : {
              'generate-index': `node ${binariesPath(isConfigsPackage)}/generate-index.ts run ${packageName} \
${prefixForAutogeneratedIndex}`,
              'auto-generate-index': `node ${binariesPath(isConfigsPackage)}/generate-index.ts watch ${packageName} \
${prefixForAutogeneratedIndex}`,
            }),
        },
