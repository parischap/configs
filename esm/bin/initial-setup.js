...
import { configsPackageName, packageJsonFilename, prodFolderName, slashedScope, testUtilsPackageName, tsConfigFilename } from "../constants.js";
...
/**
 * Creates a file with the given content if it does not exist. Does nothing if the file already exists
...
/**
 * Creates a default package.json file with the given name at the given path if it does not exist. Does nothing otherwise
...
const testPath = `../${testUtilsPackageName}/${prodFolderName}`
/* eslint-disable-next-line functional/no-expression-statements */
mkDir(testPath);
/* eslint-disable-next-line functional/no-expression-statements */
